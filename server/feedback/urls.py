from .views import FilterFeedback, GetAvgDistrictSubdivision, GetRes2, form, GetRatingCount, GetTotalCountDistrictSubdivision, GetTotalFeedbackCount, GetCountForEachRating
