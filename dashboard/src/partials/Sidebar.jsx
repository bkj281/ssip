        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul style={{ marginTop: '0.75rem' }} className='pl-0'>
              ...
              {/* Messages */}
              <li style={{ padding: '0.5rem 0.75rem' }} className={`rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-slate-900'}`}>
                <NavLink
                  to="/"
                  className={`text-decoration-none block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('messages') && 'hover:text-slate-200'
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
              ...
              <li style={{ padding: '0.5rem 0.75rem' }} className={`rounded-sm mb-0.5 last:mb-0 ${pathname.includes('qr-generator') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    <ImQrcode size={23} />
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">QR Generator</span>
                  </div>
                </NavLink>
              </li>

              {/* Calendar */}
              <li style={{ padding: '0.5rem 0.75rem' }} className={`rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                <NavLink
                  to="/"
                  className={`text-decoration-none block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('calendar') && 'hover:text-slate-200'
                    }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              {/* Campaigns */}
              <li style={{ padding: '0.5rem 0.75rem' }} className={`rounded-sm mb-0.5 last:mb-0 ${pathname.includes('campaigns') && 'bg-slate-900'}`}>
                <NavLink
                  to="/"
                  className={`text-decoration-none block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('campaigns') && 'hover:text-slate-200'
                    }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
